...
*/
var operation = {  '+': function (numero1, numero2) { 
...
*/
function showOperatioMessage(operador, numero1, numero2){
...
function showErrorMessage(operador){
	if (!isOperatorValid(operador) || typeof numero1 !== 'number' && typeof numero2 != 'number') {
...
if ( sum ) {
	number1 = 10;
	number2 = 10;
	console.log(showOperatioMessage(operationSignal, number1, number2), sum(number1, number2));
}else{
...
if (subtaction) {
	number1 = 10;
	number2 = 10;
	console.log(showOperatioMessage(operationSignal,number1, number2), subtaction(number1,number2))
}else{
	console.log(showErrorMessage(operationSignal))
}
...
if (multiplication) {
	number1 = 10;
	number2 = 10;
	console.log(showOperatioMessage(operationSignal,number1, number2), multiplication(number1,number2))
}else{
	console.log(showErrorMessage(operationSignal))
}
...
if (division) {
	number1 = 10;
	number2 = 10;
	console.log(showOperatioMessage(operationSignal,number1, number2), division(number1,number2))
}else{
	console.log(showErrorMessage(operationSignal))
}
...
if (resto) {
	number1 = 10;
	number2 = 10;
	console.log(showOperatioMessage(operationSignal,number1, number2), resto(number1,number2))
}else{
	console.log(showErrorMessage(operationSignal))
}
/*
...
*/
var operationSignal = 'pp';
var pp = calculator(operationSignal)

if (pp) {
	number1 = 10;
	number2 = 10;
	console.log(showOperatioMessage(operationSignal,number1, number2), pp(number1,number2))
}else{
	console.log(showErrorMessage(operationSignal))
}
